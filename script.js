...
document.getElementById("grade").addEventListener("change", () => stepShow("couplingGrade", "Pipe grade"));
document.getElementById("couplingGrade").addEventListener("change", () => stepShow("coupling", "Coupling grade"));
